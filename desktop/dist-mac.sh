...
echo "========== 全部构建完成 =========="
echo "输出目录：release/"
echo "  完整版（Intel）：AI漫剧工作台-x.x.x-mac-x64.dmg"
echo "  完整版（ARM）  ：AI漫剧工作台-x.x.x-mac-arm64.dmg"
echo "  纯净版（Intel）：AI漫剧工作台-Lite-x.x.x-mac-x64.dmg"
echo "  纯净版（ARM）  ：AI漫剧工作台-Lite-x.x.x-mac-arm64.dmg"
echo ""
