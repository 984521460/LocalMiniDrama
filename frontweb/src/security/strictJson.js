...
export function parseStrictJson(text, maximumLength = 1048576) {
  if (typeof text !== 'string' || !Number.isSafeInteger(maximumLength)
    || maximumLength < 1 || text.length > maximumLength) invalid()
