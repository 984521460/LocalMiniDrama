...
const ERROR_CODE = 'CHARACTER_CANDIDATE_HISTORY_REQUEST_FAILED'

export function useCharacterCandidateHistory({ api = characterCandidateExecutionAPI } = {}) {
  ...
  function refresh(input) {
    return requestPage(input, true)
  }

  function loadMore(input) {
    return requestPage(input, false)
  }
